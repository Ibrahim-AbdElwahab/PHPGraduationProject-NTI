...
//  Check role for security, if not admin redirect to the main login page
...
//Include database connection file (step back to reach the main directory)
require '../includes/dbConnection.php';
global $connection;

// Fetch database stats to display them inside dashboard cards
...
// Fetch all appointments with JOIN to get patient name and doctor name
